...
import com.cvcloud.utils.BaseColumnConstants._
...
case class ActualPart(id: String, contentType: String, filename: String, documentType: String, date: Option[Date])
...
case class UpdateFileCommand(id: String, file: Option[FilePart[TemporaryFile]], constant: FileConstant)
...
case object RESUMECONSTANT extends FileConstant
