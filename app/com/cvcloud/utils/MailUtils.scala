...
package object mail {
  ...
  object send {
    def a(mail: Mail): String = {
      ...
      commonsMail.setHostName(Constants.SMTP_HOST)
      commonsMail.setSmtpPort(Constants.SMTP_PORT)
      commonsMail.setSSLOnConnect(true)
      commonsMail.setAuthentication(Constants.SENDER_EMAIL, Constants.SENDER_PASSWORD)
      commonsMail.
